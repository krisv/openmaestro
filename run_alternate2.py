...
from app.agent.mini_maestro import MiniMaestro
...
async def run_flow():
    ...
    mini_maestro_agent = MiniMaestro(memory = memory)
    agents = {
        "mini_maestro": mini_maestro_agent
    }
    try:
        ...
        prompt = "Can you save the Red Hat organizational structure of everyone reporting to MarkL in a text file?"
        mockLLM._set_scenario("scenario2")
